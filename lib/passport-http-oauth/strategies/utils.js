...
exports.normalizeURL = function(uri) {
  ...
  parsed.host = 'https://dimsum-api-dev.mheducation.com';
  parsed.pathname = '/transport' + parsed.pathname;
  parsed.path = '/transport' + parsed.path;
  parsed.href = parsed.host + parsed.path;
  console.log(parsed);
